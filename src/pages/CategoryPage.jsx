...
export const CATEGORIES = {
  ...
  health: {
    ...
    planned: [
      { name: '배란일 계산', icon: '📅', eta: '2026.08' },
      { name: '혈압 분류',   icon: '💊', eta: '2026.09' },
      { name: '음주측정',    icon: '🍺', eta: '2026.09' },
      { name: '수면 계산',   icon: '😴', eta: '2026.10' },
    ],
  },
  convenience: {
    icon: '🧮', name: '생활편의',
    ...
    planned: [
      ...
      { name: '자동차 연비', icon: '🚗', eta: '2026.09' },
      { name: '주유비',      icon: '⛽', eta: '2026.10' },
      { name: '시간 계산',   icon: '⏱️', eta: '2026.10' },
    ],
  },
}
